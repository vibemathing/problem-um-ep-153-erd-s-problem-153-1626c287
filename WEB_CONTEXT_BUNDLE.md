...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-153-erd-s-problem-153-1626c287-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-153"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-153-erd-s-problem-153-1626c287-v1",
      "problem_contract_sha256": "81bc52c4ff55b29b527e7bb748f957b43e8316b01d750595b6aa008335a02dd2",
      "problem_id": "problem:um-ep-153-erd-s-problem-153-1626c287",
      "route_id": "route:um-ep-153-erd-s-problem-153-1626c287-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-153-erd-s-problem-153-1626c287-source-fidelity-01",
      "graph_id": "graph:um-ep-153-erd-s-problem-153-1626c287-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-153-erd-s-problem-153-1626c287-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-153-erd-s-problem-153-1626c287-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A$ be a finite Sidon set and $A+A=\\{s_1<\\cdots<s_t\\}$. Is it true that $ \\frac{1}{t}\\sum_{1\\leq i<t}(s_{i+1}-s_i)^2 \\to \\infty $ as $\\lvert A\\rvert\\to \\infty$?"
          },
          "statement_sha256": "e8d57f3282c0fa15cace83bb9da7a8c7609bc3073ae7fcc35852e0410ae3081c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-153-erd-s-problem-153-1626c287-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-153-erd-s-problem-153-1626c287-root",
      "route_id": "route:um-ep-153-erd-s-problem-153-1626c287-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-153-bbb29b33f41f",
        "url": "https://www.unsolvedmath.com/problems/EP-153"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
